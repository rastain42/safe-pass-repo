...
import { useTicketPurchase } from '@/hooks/tickets/useTicketPurchase';
...
export default function EventDetailsScreen() {
  ...
  const { userData } = useUserProfile(); // Vérifier si l'utilisateur peut accéder aux billets
      ...
      <ScrollView style={styles.container} ref={scrollViewRef}>
        <Image
          source={
            event.image
              ? { uri: event.image }
              : require('../../../assets/images/safepasslogoV1.png')
          }
          style={styles.image}
        />
        ...
        <View style={styles.content}>
          ...
          <View style={styles.infoRow}>
            ...
            <Text style={styles.infoText}>{formatEventDateTime(event.start_date)}</Text>
          </View>
          <View style={styles.infoRow}>
          ...
          <View style={styles.ticketsContainer}>
            ...
            {!canAccessTickets ? (
              <View style={styles.accessRestrictedContainer}>
                ...
                <Text style={styles.accessRestrictedTitle}>Vérification d'identité requise</Text>
                ...
                return (
                  <View key={ticket.id} style={styles.ticketRow}>
                    <View style={styles.ticketInfo}>
                      ...
                      {isTicketSoldOut && <Text style={styles.soldOutText}>SOLD OUT</Text>}
                    </View>
                    {!isTicketSoldOut ? (
          ...
          {totalAmount > 0 && (
            <View style={styles.totalContainer}>
              ...
              <View style={styles.buttonContainer}>
                ...
                >
                  <Text style={styles.purchaseButtonText}>Payer avec Carte</Text>
                </TouchableOpacity>
