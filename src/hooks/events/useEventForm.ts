...
import { createEvent, pickAndProcessImage, EventFormData } from '@/services/events/event.service';
import { useTicketManagement } from '@/hooks/tickets/useTicketManagement';
  ...
  const onSubmit = async (data: EventFormData) => {
    try {
      ...
      const formData = {
        ...
        age_restriction: data.allowUnverifiedUsers ? AgeRestriction.None : data.age_restriction,
