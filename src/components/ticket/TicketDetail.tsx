            ...
            try {
                ...
                if (eventDoc.exists()) {
                    ...
                    if (eventData.start_date) {
                        ...
                        if (eventData.
                            start_date.toDate) {
                            setStartEventDate(eventData.
                                start_date.toDate());
                        }
                        // Si c'est une chaîne ISO
                        else if (typeof eventData.
                            start_date === 'string') {
                            setStartEventDate(parseISO(eventData.
                                start_date));
                        }
                        ...
                        // Si c'est un nombre (timestamp en millisecondes)
                            ...
                            setStartEventDate(new Date(eventData.
                                start_date));
                        }
                    }
                    // Récupération et traitement de la date de l'événement
                    if (eventData.end_date) {
                        ...
                        if (eventData.
                            end_date.toDate) {
                            setEndEventDate(eventData.
                                end_date.toDate());
                        }
                        // Si c'est une chaîne ISO
                        else if (typeof eventData.
                            end_date === 'string') {
                            setEndEventDate(parseISO(eventData.
                                end_date));
                        }
                        // Si c'est déjà un objet Date
                        ...
                        // Si c'est un nombre (timestamp en millisecondes)
                            ...
                            setEndEventDate(new Date(eventData.
                                end_date));
                        }
                    }
                }
            ...
            <View style={styles.ticketDetailCard}>
                ...
                <View style={styles.ticketInfo}>
                    ...
                    <View style={styles.infoRow}>
                        ...
                        <Text style={styles.infoValue}>
                            {format(ticket.purchaseDate instanceof Date
                                ? ticket.purchaseDate
